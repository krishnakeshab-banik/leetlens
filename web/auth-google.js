...
<rect width="24" height="24" fill="white"/>
  ...
  // src/auth-google-bridge.js
  var require_auth_google_bridge = __commonJS({
    "src/auth-google-bridge.js"() {
      init_define_FIREBASE_CONFIG();
      init_index_esm();
      init_index_esm2();
      ...
      window.addEventListener("message", async (event) => {
        ...
        const parentOrigin = event.data.parentOrigin || document.location.ancestorOrigins && document.location.ancestorOrigins[0] || event.origin;
        try {
