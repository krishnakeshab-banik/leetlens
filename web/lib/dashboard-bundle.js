(() => {
  ...
  var googleOAuthClientId = true ? "225177526072-3hfdst13ahamatieqms6hddermifo4eh.apps.googleusercontent.com" : "225177526072-3hfdst13ahamatieqms6hddermifo4eh.apps.googleusercontent.com";
...
${redirectUri}`));
  ...
  async function signInWithGoogleWebAuthFlow() {
    ...
    const result = await signInWithCredential(auth2, credential);
    return result.user;
  }
