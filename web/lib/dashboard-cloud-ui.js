    ...
    container.innerHTML = `
      <div class="profile-page-card">
        ...
        <div class="profile-section">
          <h3 class="profile-section-title"><span class="material-symbols-outlined">code</span> LeetCode Account</h3>
      ...
      hub.innerHTML = `
        ...
        <div class="sync-summary-card">
          <div class="sync-summary-item">
            <span class="material-symbols-outlined sync-summary-icon lc">code</span>
